...
void ffdot(UserStatePtr user)
{
    ...
    value.int32Value = (SignedCell)UPOP();
...
void fgreater(UserStatePtr user)
{
    ...
    value2.int32Value = (SignedCell)UPOP();
    value1.int32Value = (SignedCell)UPOP();
...
void fFtoI(UserStatePtr user)
 {
    ...
    SignedCell   value;
    value1.int32Value = (SignedCell)UPOP();
    value = (SignedCell)(value1.float32Value);
    push(user,value);
 }
...
void mComputeVectorMagnitude2D(UserStatePtr user)
{
    ...
    yValue.int32Value = (SignedCell)UPOP();
    xValue.int32Value = (SignedCell)UPOP();
