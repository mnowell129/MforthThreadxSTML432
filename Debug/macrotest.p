# 1 "../Drivers/Custom/macrotest.c"
# 1 "C:/Work/Aergility/MassStorage/SigGen/Debug//"
# 1 "<built-in>"
#define __STDC__ 1
...
#define TX_PORT_BASEPRI 80
#define TX_INCLUDE_USER_DEFINE_FILE 1
# 1 "../Drivers/Custom/macrotest.c"
# 1 "../Core/Inc/SelectIO.h" 1
...
# 2 "../Drivers/Custom/macrotest.c" 2
# 1 "../Drivers/Custom/gpiointerface.h" 1
# 28 "../Drivers/Custom/gpiointerface.h"
#define GPIOINTERFACE_H 
# 63 "../Drivers/Custom/gpiointerface.h"
...
#define GPIO_INIT(name,mode,alternate) GPIO_CLOCK_ENABLE(name); gpioInitializePin(name ##_PORT_BASE, mode, name ##_PIN_MASK, name ##_PIN_DRIVE, name ##_PIN_PULLSTATE, name ##_PIN_SPEED, name ##_PIN_INIT_STATE,alternate)
# 87 "../Drivers/Custom/gpiointerface.h"
...
#define GPIO_INIT_AS_ALTERNATE(name) GPIO_INIT(name,LL_GPIO_MODE_INPUT,name ##_AF_NUMBER)
...
# 3 "../Drivers/Custom/macrotest.c" 2


   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA); gpioInitializePin(GPIOA, LL_GPIO_MODE_INPUT, LL_GPIO_PIN_9, LL_GPIO_OUTPUT_PUSHPULL, LL_GPIO_PULL_NO, LL_GPIO_SPEED_FREQ_VERY_HIGH, false,LL_GPIO_AF_7);
   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA); gpioInitializePin(GPIOA, LL_GPIO_MODE_INPUT, LL_GPIO_PIN_10, LL_GPIO_OUTPUT_PUSHPULL, LL_GPIO_PULL_NO, LL_GPIO_SPEED_FREQ_VERY_HIGH, false,LL_GPIO_AF_7);

   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
   HOST_GREEN_ENABLE_FN(HOST_GREEN_ENABLE_SELECT); gpioInitializePin(HOST_GREEN_PORT_BASE, LL_GPIO_MODE_INPUT, HOST_GREEN_PIN_MASK, HOST_GREEN_PIN_DRIVE, HOST_GREEN_PIN_PULLSTATE, HOST_GREEN_PIN_SPEED, HOST_GREEN_PIN_INIT_STATE,0);
   LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB); gpioInitializePin(GPIOB, LL_GPIO_MODE_OUTPUT, LL_GPIO_PIN_3, LL_GPIO_OUTPUT_PUSHPULL, LL_GPIO_PULL_NO, LL_GPIO_SPEED_FREQ_VERY_HIGH, false,0);

   gpioWriteBits(GPIOB,LL_GPIO_PIN_3, true);
   gpioWriteBits(GPIOB,LL_GPIO_PIN_3, false);
